...
namespace DOL.GS
{
    public static class ClientService
    {
        ...
        private static void Send(GameClient client)
        {
            ...
            if (ServiceUtils.ShouldTickAdjust(ref client.PacketProcessor.NextTcpSend))
                client.PacketProcessor.SendPendingTcp();

            if (ServiceUtils.ShouldTickAdjust(ref client.PacketProcessor.NextUdpSend))
                client.PacketProcessor.SendPendingUdp();
